        ...
        <div class="card shadow-none mb-2">
            <div class="card-body row p-2">
                ...
                <div class="col text-truncate">
                    ...
                    <p class="card-text mb-0 text-secondary">@if($model->type == 'PROVIDER')
                        Fornecedor
                        @else
                        Comprador
                        @endif
                ...
                <div class="col text-truncate">
                    {{ $model->phone }}
                    <p class="card-text mb-0 text-secondary"> Criado em: {{ $model->created_at->format('d/m/Y') }} as {{ $model->created_at->format('H:i') }}</p>
